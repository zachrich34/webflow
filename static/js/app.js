...
const TRANSLATIONS = {
  fr: {
    ...
    'step2-title':'Sélectionnez le navigateur <span style="color:var(--accent1)">source</span>',
    'step2-subtitle':'Quel navigateur voulez-vous utiliser comme source ?',
    'step2-profile-label':'Profil',
    'step2-back':'← Retour','step2-next':'Suivant →',
    'step3-title':'Que <span style="color:var(--accent2)">transférer</span> ?',
    'step3-subtitle':'Sélectionnez les données à déplacer vers le nouveau navigateur.',
    'step3-security-alert':'⚠️ Les <strong>cookies</strong> et les <strong>moyens de paiement</strong> ne peuvent pas être transférés pour des raisons de sécurité.',
    'step3-scanning':'Analyse des données du navigateur…',
    'step3-back':'← Retour','step3-scan':'Scanner','step3-next':'Suivant →',
    'step4-title':'Sélectionnez le navigateur de <span style="color:var(--accent3)">destination</span>',
    'step4-subtitle':'Quel navigateur voulez-vous utiliser comme destination ?',
  ...
  en: {
    ...
    'step2-title':'Select <span style="color:var(--accent1)">source</span> browser',
    'step2-subtitle':'Which browser do you want to transfer data from?',
    'step2-profile-label':'Profile',
    'step2-back':'← Back','step2-next':'Next →',
    'step3-title':'What to <span style="color:var(--accent2)">transfer</span>?',
    'step3-subtitle':'Select the data you want to move to the new browser.',
    'step3-security-alert':'⚠️ <strong>Cookies</strong> and <strong>payment methods</strong> cannot be transferred for security reasons.',
    'step3-scanning':'Scanning browser data…',
    'step3-back':'← Back','step3-scan':'Scan browser','step3-next':'Next →',
    'step4-title':'Select <span style="color:var(--accent3)">destination</span> browser',
    'step4-subtitle':'Which browser do you want to transfer data to?',
  ...
  de: {
    ...
    'step2-title':'<span style="color:var(--accent1)">Quell</span>browser auswählen',
    'step2-subtitle':'Welchen Browser möchten Sie als Quelle verwenden?',
    'step2-profile-label':'Profil',
    'step2-back':'← Zurück','step2-next':'Weiter →',
    'step3-title':'Was <span style="color:var(--accent2)">übertragen</span>?',
    'step3-subtitle':'Wählen Sie die Daten aus, die Sie in den neuen Browser verschieben möchten.',
    'step3-security-alert':'⚠️ <strong>Cookies</strong> und <strong>Zahlungsmethoden</strong> können aus Sicherheitsgründen nicht übertragen werden.',
    'step3-scanning':'Browserdaten werden gescannt…',
    'step3-back':'← Zurück','step3-scan':'Browser scannen','step3-next':'Weiter →',
    'step4-title':'<span style="color:var(--accent3)">Ziel</span>browser auswählen',
    'step4-subtitle':'Welchen Browser möchten Sie als Ziel verwenden?',
  ...
  ru: {
    ...
    'step2-title':'Выберите <span style="color:var(--accent1)">исходный</span> браузер',
    'step2-subtitle':'Какой браузер вы хотите использовать как источник?',
    'step2-profile-label':'Профиль',
    'step2-back':'← Назад','step2-next':'Далее →',
    'step3-title':'Что <span style="color:var(--accent2)">перенести</span>?',
    'step3-subtitle':'Выберите данные для переноса в новый браузер.',
    'step3-security-alert':'⚠️ <strong>Cookies</strong> и <strong>способы оплаты</strong> не могут быть перенесены по соображениям безопасности.',
    'step3-scanning':'Сканирование данных браузера…',
    'step3-back':'← Назад','step3-scan':'Сканировать','step3-next':'Далее →',
    'step4-title':'Выберите <span style="color:var(--accent3)">целевой</span> браузер',
    'step4-subtitle':'Какой браузер вы хотите использовать как назначение?',
  ...
  tr: {
    ...
    'step2-title':'<span style="color:var(--accent1)">Kaynak</span> tarayıcıyı seçin',
    'step2-subtitle':'Kaynak olarak hangi tarayıcıyı kullanmak istiyorsunuz?',
    'step2-profile-label':'Profil',
    'step2-back':'← Geri','step2-next':'İleri →',
    'step3-title':'Ne <span style="color:var(--accent2)">aktarılsın</span>?',
    'step3-subtitle':'Yeni tarayıcıya taşımak istediğiniz verileri seçin.',
    'step3-security-alert':'⚠️ <strong>Çerezler</strong> ve <strong>ödeme yöntemleri</strong> güvenlik nedeniyle aktarılamaz.',
    'step3-scanning':'Tarayıcı verileri taranıyor…',
    'step3-back':'← Geri','step3-scan':'Tara','step3-next':'İleri →',
    'step4-title':'<span style="color:var(--accent3)">Hedef</span> tarayıcıyı seçin',
    'step4-subtitle':'Hedef olarak hangi tarayıcıyı kullanmak istiyorsunuz?',
  ...
  es: {
    ...
    'step2-title':'Seleccionar navegador de <span style="color:var(--accent1)">origen</span>',
    'step2-subtitle':'¿Qué navegador quieres usar como origen?',
    'step2-profile-label':'Perfil',
    'step2-back':'← Atrás','step2-next':'Siguiente →',
    'step3-title':'¿Qué <span style="color:var(--accent2)">transferir</span>?',
    'step3-subtitle':'Selecciona los datos que quieres mover al nuevo navegador.',
    'step3-security-alert':'⚠️ Las <strong>cookies</strong> y los <strong>métodos de pago</strong> no se pueden transferir por razones de seguridad.',
    'step3-scanning':'Analizando datos del navegador…',
    'step3-back':'← Atrás','step3-scan':'Escanear','step3-next':'Siguiente →',
    'step4-title':'Seleccionar navegador de <span style="color:var(--accent3)">destino</span>',
    'step4-subtitle':'¿Qué navegador quieres usar como destino?',
